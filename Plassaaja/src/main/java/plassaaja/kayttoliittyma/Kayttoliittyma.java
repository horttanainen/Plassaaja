...
/**
 *Kayttoliittyma on plassaajan tekstikäyttöliittymä. Käyttöliittymä tarjoaa
 * plassaavalle taholle vaihtoehdot sitsaajen lisäämiseen, poistamiseeen, tieto-
 * jen muokkaamiseen ja itse plassauksen tulostukseen.
 * @author Santeri
 */
public class Kayttoliittyma {
/**
 * Scannerolio joka vastaanottaa käyttäjän syötteen.
 */
    private Scanner lukija;
    /**
     * Työkalut sitsaajien lisäämistä ja muokkaamista varten.
     */
